#!/bin/bash
#全局变量
download_url=https://raw.githubusercontent.com/Jiaocha/bt77happy/main/btpanel_tools
...
degrade_btpanel(){
    ...
    wget -T 5 -O panel.zip https://raw.githubusercontent.com/Jiaocha/bt77happy/main/btpanel_tools/update/LinuxPanel-${version}.zip
