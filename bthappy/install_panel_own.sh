...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://cdn.jsdelivr.net/gh/Jiaocha/bt77happy@main/bthappy/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://cdn.jsdelivr.net/gh/Jiaocha/bt77happy@main/bthappy/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://raw.githubusercontent.com/Jiaocha/bt77happy/main/bthappy/public.sh -T 10
	wget -O panel.zip https://cdn.jsdelivr.net/gh/Jiaocha/bt77happy@main/bthappy/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://cdn.jsdelivr.net/gh/Jiaocha/bt77happy@main/bthappy/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://cdn.jsdelivr.net/gh/Jiaocha/bt77happy@main/bthappy/bt7.init -T 10
