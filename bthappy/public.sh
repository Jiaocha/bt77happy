...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/Jiaocha/bt77happy/main/bthappy/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/Jiaocha/bt77happy/main/bthappy/update6.sh|bash
	fi
